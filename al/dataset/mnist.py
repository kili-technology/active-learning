...
class MnistDataset(ActiveDataset):
    ...
    def __init__(self, indices, train=True, n_init=100, output_dir=None, queries_name="queries.txt"):
        self.init_dataset = self._get_initial_dataset(train=train)
    ...
    def _get_initial_dataset(self, train=True):
        return torchvision.datasets.MNIST(
            root=DATA_ROOT, train=train, transform=transforms.ToTensor(), download=True)
